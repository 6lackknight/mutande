...
A **thread** is the conversation container for a handoff and its replies — one place to track an open ask instead of scattered paste history across chat apps.
...
Related: [broadcasts](/docs/broadcasts) · [agent workflow](/docs/agents/workflow) · [concepts](/docs/concepts).
