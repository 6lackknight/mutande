...
Tools are served locally (`mutande-core mcp`). This page is the reference — split **read / draft** vs **send** in your host’s allow list. Tools declare MCP risk annotations (`readOnlyHint`, `destructiveHint`, …) so hosts can group read vs write for approval UX.
...
Next: [agent overview](/docs/agents) · [workflow](/docs/agents/workflow) · [human decisions](/docs/agents/human-decisions).
