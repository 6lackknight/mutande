...
Plans from `improve-animations` at commit **946c2bc**. Executors have zero audit context — follow each plan’s Target, Steps, and Boundaries exactly. Do not edit `thinking_orb.dart` motion or the onboarding address rail unless a plan names that file.

| # | File | Severity | Status | Title |
| --- | --- | --- | --- | --- |
| 008 | [008-mutande-motion-tokens.md](008-mutande-motion-tokens.md) | LOW | TODO | Add `MutandeMotion` tokens |
| 001 | [001-search-palette-no-animation.md](001-search-palette-no-animation.md) | HIGH | TODO | Remove search palette open animation |
| 002 | [002-chrome-pills-ease.md](002-chrome-pills-ease.md) | HIGH | TODO | Ease high-frequency pill/thumb color |
| 003 | [003-gate-disable-animations.md](003-gate-disable-animations.md) | HIGH | TODO | Gate everyday motion with `disableAnimations` |
| 004 | [004-connect-host-scale.md](004-connect-host-scale.md) | MEDIUM | TODO | Connect-host scale 0.95; delete dead check wait |
| 005 | [005-threads-list-kill-ink.md](005-threads-list-kill-ink.md) | MEDIUM | TODO | Kill Material ink on Threads list |
| 006 | [006-network-graph-enter.md](006-network-graph-enter.md) | MEDIUM | TODO | Cap Network graph enter; quiet hover |
| 007 | [007-mail-accordion.md](007-mail-accordion.md) | MEDIUM | TODO | Mail accordion: no layout animation |
| 009 | [009-splash-fade-out.md](009-splash-fade-out.md) | LOW | TODO | Splash 200ms opacity fade out |
| 010 | [010-inspector-slide-from-right.md](010-inspector-slide-from-right.md) | MEDIUM | TODO | Inspector slides from the right |
| 011 | [011-skeleton-content-crossfade.md](011-skeleton-content-crossfade.md) | LOW | TODO | Skeleton → content 200ms opacity crossfade |
| 012 | [012-composer-search-focus-ring.md](012-composer-search-focus-ring.md) | LOW | TODO | Match composer and search focus rings |
...
Suggested serial path: **008 → 001 → 002 → 003 → 005 → 012 → 004 → 006 → 007 → 009 → 010 → 011**.
...
- MacosSheet bounce (not selected)
