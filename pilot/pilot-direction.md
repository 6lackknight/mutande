...
| Weekly note | `pilot/sessions/YYYY-MM-DD-weekly.md` | Waitlist + Mixpanel + asks; latest: `2026-08-16-weekly.md` |
...
- Waitlist: **9 entries** (Aug 4–8, 2026) — last successful `/admin/ops` export **2026-08-13**. 2026-08-16 weekly run: hub reachable, but placeholder Auth0 token → 401; no Mixpanel Query creds. Fri/Sat drafts (PRs #7/#8) still unanswered
- Mixpanel: instrumented on web + desktop 1.1.4; **live counts missing** — iOS / `surface=mobile` not shipped. Try Alpha now goes through the waitlist form. See weekly note ask
...
- [ ] Refresh waitlist + Mixpanel on the next weekly note (2026-08-16 run: hub up, token 401, no Query creds)
