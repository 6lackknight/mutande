...
| Weekly note | `pilot/sessions/YYYY-MM-DD-weekly.md` | Waitlist + Mixpanel + asks; latest: `2026-08-14-weekly.md` |
...
- Waitlist: **9 entries** (Aug 4–8, 2026) — last successful `/admin/ops` export **2026-08-13**. 2026-08-14 weekly run could not refresh (empty hub token + Cloudflare 1010; no Mixpanel Query creds)
- Mixpanel: instrumented on web + desktop 1.1.4; **live counts missing** — see weekly note ask
...
- [ ] Refresh waitlist + Mixpanel on the next weekly note (2026-08-14 run was blocked)
