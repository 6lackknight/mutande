...
- `thread-meta.schema.json` — hub-visible thread headers (includes `encryption_mode`)
- `envelope.schema.json` — E2E blind wire unit (`wraps[]`)
- `app-envelope.schema.json` — hub-readable payload for non-E2E threads (L2; never mix with envelope)
